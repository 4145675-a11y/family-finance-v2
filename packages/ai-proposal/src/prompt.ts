...
export const INSTRUCTIONS = [
  ...
  '2. תאריך — date הוא היום שבו הכסף זז בפועל, ורק אם המשפט אומר מתי. "היום" הוא התאריך',
  '   שנמסר לך. אין תאריך במשפט — null. date לעולם לא בעתיד.',
  '2א. dueDate הוא היום שבו צריך להחזיר כסף שנלווה ("לפירעון ב־10/10/2026"). הוא יכול להיות',
  '   בעתיד, והוא איננו date. אין מועד פירעון במשפט — null.',
  '3. מזהים — להעתיק בדיוק מהרשימות שנמסרו. לעולם לא להמציא מזהה ולא לכתוב שם במקום מזהה.',
  '4. מלווה — lenderText הוא המילים מהמשפט שמזהות את המלווה, מועתקות כלשונן. לעולם לא מזהה,',
  '   ולעולם לא שם מהרשימה שהמשפט לא השתמש בו. אין במשפט מלווה — null.',
  '4א. "עוד", "נוספת", "תוספת" ליד הלוואה פירושם כסף נוסף ממלווה שכבר קיים: action הוא',
  '   new_principal. "לקחתי הלוואה" בלי "עוד" הוא new_debt.',
