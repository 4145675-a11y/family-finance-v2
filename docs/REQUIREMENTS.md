...
| `PROD-FAILCLOSED-001` | build של ייצור שמוגדר לחנות המקומית אינו מגיש את האפליקציה: כל בקשה 503, health `misconfigured`; אין דגל שפותח את הדלת | 05-ARCHITECTURE-DATA.md § גבולות | 9 | Verified (M9) — ADR-0031; **המנגנון תוקן ב־ADR-0034 (2026-09-15)**: לא exit אלא סירוב לכל בקשה; `check:fail-closed` 22/22 |
